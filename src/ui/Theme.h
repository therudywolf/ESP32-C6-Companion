...
/* Cyberpunk 2077 HUD: samurai-red chrome, cyan data, amber warnings. */
constexpr uint16_t BG = rgb(0x04, 0x03, 0x04);
constexpr uint16_t ORANGE = rgb(0xFF, 0x1B, 0x3C);      /* chrome: samurai red */
constexpr uint16_t ORANGE_DIM = rgb(0x60, 0x0A, 0x18);  /* inactive chrome */
constexpr uint16_t TEXT = rgb(0xD6, 0xF8, 0xFF);        /* cyan-white */
constexpr uint16_t DIM = rgb(0x4E, 0x6E, 0x78);         /* secondary text */
constexpr uint16_t PANEL = rgb(0x14, 0x0A, 0x0E);       /* panel fill */
constexpr uint16_t GOOD = rgb(0x00, 0xE0, 0xB0);        /* ok = cyan-green */
constexpr uint16_t WARN = rgb(0xFF, 0xB0, 0x00);        /* amber */
constexpr uint16_t CRIT = rgb(0xFF, 0x00, 0x3C);        /* alarm red (blinks) */
constexpr uint16_t INFO = rgb(0x00, 0xF0, 0xFF);        /* data cyan */
constexpr uint16_t ACCENT = rgb(0xFF, 0xB0, 0x00);      /* amber accent */
