...
static const Preset kPresets[THEME_PRESETS] = {
    ...
    /* 24..26 — одноцветные диодные табло к янтарному (23) и зелёному
     * Matrix (1). Каждое — один люминофор на чёрном стекле, роли различаются
     * накалом, а не оттенком; тревога и «хорошо» получают один-два чужих
     * цвета, как на настоящем табло с двухцветными диодами. Все три
     * проходят порог контраста — DIM подобран счётом, как и у янтарного:
     * диод «вполнакала» на глаз правдоподобен и нечитаем. Включи сверху
     * `dots 1` — и это матрица; включи поверх полноцветной темы — RGB. */
    {"Диод красный", rgb(6, 2, 2), rgb(255, 64, 48), rgb(255, 120, 100),
     rgb(208, 87, 70), rgb(28, 8, 6), rgb(120, 255, 120), rgb(255, 190, 60),
     rgb(255, 40, 40), rgb(255, 150, 130), rgb(255, 96, 80)},
    {"Диод синий", rgb(2, 2, 8), rgb(70, 140, 255), rgb(150, 200, 255),
     rgb(96, 128, 210), rgb(6, 10, 30), rgb(110, 255, 140), rgb(255, 200, 70),
     rgb(255, 80, 80), rgb(120, 190, 255), rgb(100, 160, 255)},
