...
struct ServiceEntry {
  /* 28 байт, а не 17. Шестнадцать байт — это восемь русских букв, и «ВПН
   * Протон» превращалось в «ВПН Прот». Обрезка тихая, и выглядит она как
   * нехватка ширины на экране, где ширины хватает. */
  char name[28] = {0};
  char status[6] = {0};
  int ms = -1;
};
