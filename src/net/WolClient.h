...
/* "AA-BB-CC-DD-EE-FF", "aa:bb:cc:dd:ee:ff" and "AABBCCDDEEFF" all parse.
 ...
 *
 * `bcast` should be the local broadcast (e.g. 192.168.1.10) rather than
 ...
 * hardcode 192.168.1.10 and quietly break when the network moves. */
