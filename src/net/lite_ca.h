 ...
 *
 * The fallback host (rudywolf.ru, a public Caddy vhost) serves a Let's Encrypt
 ...
 *     by default, so the live rudywolf.ru cert actually roots at X2 (X1 only
 ...
 *
 * Generated from the server's ca-certificates store (ISRG_Root_X1/X2.crt).
 */
#ifndef NOCT_LITE_CA_H
#define NOCT_LITE_CA_H

#define NOCT_ISRG_ROOT_X1 \
    "-----BEGIN CERTIFICATE-----\n" \
...
/* Trust bundle: both roots concatenated (adjacent string-literal concatenation). */
static const char *LITE_CA_BUNDLE = NOCT_ISRG_ROOT_X1 NOCT_ISRG_ROOT_X2;
